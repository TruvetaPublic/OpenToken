...
public class EncryptTokenTransformer implements TokenTransformer{
     ...
     * 
     * @throws java.security.NoSuchAlgorithmException invalid encryption algorithm/mode.
     * @throws javax.crypto.NoSuchPaddingException invalid encryption algorithm padding.
     ...
     */
    public EncryptTokenTransformer(String encryptionKey) throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException, InvalidAlgorithmParameterException {
        ...
        // Generate random IV (16 bytes for AES block size) - using zero IV for simplicity
     ...
     * is in a wrong state.
     * @throws javax.crypto.IllegalBlockSizeException if this cipher is a block cipher,
     ...
     */
    @Override
    public String transform(String token) throws IllegalStateException, IllegalBlockSizeException, BadPaddingException, AEADBadTagException {
